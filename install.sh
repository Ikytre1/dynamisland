...
# -----------------------------------------------------------------------
# System dependencies & services setup
# -----------------------------------------------------------------------
info "Installing dependencies via yay..."
yay -S --needed qt6-base qt6-declarative qt6-svg qt6-5compat networkmanager bluez bluez-utils util-linux quickshell-git upower cava mpris-qt5 pipewire pipewire-audio wireplumber ddcutil lsof psmisc wl-clipboard gawk cairo hwmon-utils procps-ng python python-cryptography bash jq libnotify slurp wf-recorder ffmpeg iproute2 pulseaudio xdg-user-dirs

info "Enabling systemd services (NetworkManager, bluetooth)..."
