 ...
 * card; a dark black surface sits behind everything.
 */
PillSurface {
    id: root
    ...
    readonly property real positionSec: PillPlayers.positionSec
    ...
    readonly property color washMid: "#0d0d0d"
    ...
    Canvas {
        ...
        MouseArea {
            ...
            onReleased: {
                if (root.player)
                    PillPlayers.setPositionSec(root.dragFrac * root.lengthSec);
                root.dragging = false;
            }
        }
    }
