...
readonly property bool barMode: !!(Config.options?.bar?.pill?.barMode)   
 readonly property bool expanded: surfaceOpen || held || hoverLatch || barMode
    ...
    Item {
        ...
        readonly property bool showGrid: PillLocalsend.lsSubMode === "send" && PillLocalsend.state === "ready" && deviceCount > 0
        ...
        Item {
            ...
            Item {
                id: chooseView
                anchors.fill: parent
                visible: PillLocalsend.lsSubMode === "choose"
                opacity: visible ? 1 : 0
            ...
            Item {
                id: receiveView
                anchors.fill: parent
                visible: PillLocalsend.lsSubMode === "receive"
                opacity: visible ? 1 : 0
                Behavior on opacity { NumberAnimation { duration: 180 } }

                readonly property bool isWaiting: PillLocalsend.recvState === "waiting"
                readonly property bool isTransferring: PillLocalsend.recvState === "transferring"
                readonly property bool isDone: PillLocalsend.recvState === "done"

                // --- Sous-état : EN ATTENTE ---
                Column {
                    anchors.centerIn: parent
                    spacing: 12 * pill.s
                    visible: receiveView.isWaiting
                    opacity: visible ? 1 : 0
                    Behavior on opacity { NumberAnimation { duration: 180 } }
                    ...
                    Text {
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: "(LocalSend is ready to receive)"
                        color: PillTheme.dim
                        font.family: PillTheme.font
                ...
                // --- Sous-état : TRANSFERT EN COURS ---
                Column {
                    anchors.centerIn: parent
                    width: parent.width - 2 * (16 * pill.s)
                    spacing: 10 * pill.s
                    visible: receiveView.isTransferring
                    opacity: visible ? 1 : 0
                    Behavior on opacity { NumberAnimation { duration: 180 } }
                    ...
                    Text {
                        ...
                        elide: Text.ElideRight
                        text: "Réception depuis " + PillLocalsend.recvSenderAlias
                        color: PillTheme.cream
                        font.family: PillTheme.font
                    ...
                    Text {
                        ...
                        text: PillLocalsend.recvCurrentFile
                        color: PillTheme.dim
                        font.family: PillTheme.font
                        font.pixelSize: 11 * pill.s
                        visible: text.length > 0
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            ...
                            radius: height / 2
                            color: PillTheme.cream
                            width: parent.width * (PillLocalsend.recvProgress / 100)
                    ...
                    Text {
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: PillLocalsend.recvProgress + "%"
                        color: PillTheme.dim
                        font.family: PillTheme.font
                ...
                Column {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignHCenter
                        elide: Text.ElideRight
                        text: "Received from " + PillLocalsend.recvSenderAlias  + " !"
                        color: "#4ade80"
                        font.family: PillTheme.font
                        font.pixelSize: 14 * pill.s
                        font.weight: Font.Bold
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignHCenter
                        elide: Text.ElideMiddle
                        text: PillLocalsend.recvLastFile
                        color: PillTheme.dim
                        font.family: PillTheme.font
                        font.pixelSize: 11 * pill.s
                    }
            ...
            Item {
                id: sendView
                anchors.fill: parent
                visible: PillLocalsend.lsSubMode === "send"
                opacity: visible ? 1 : 0
                Behavior on opacity { NumberAnimation { duration: 180 } }
    ...
    Item {
        ...
        Row {
            ...
            Row {
                ...
                // --- NOUVEAU BOUTON LOCALSEND (GLYPHE CARRÉ) ---
                Item {
                    id: localsendIcon
                    anchors.verticalCenter: parent.verticalCenter
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "localsend" // Icône carré / box
