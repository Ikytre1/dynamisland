...
Item {
    ...
    readonly property var glyphs: ({
        ...
        "app-window": { d: "M12 2l9 5v10l-9 5-9-5V7z M12 2v20 M3 7.5l18 10 M21 7.5l-18 10 M12 12l9-5 M12 12l-9-5 M12 12l9 5 M12 12l-9 5", fill: false },
        "brightness": { d: "M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z M12 2v3 M12 19v3 M2 12h3 M19 12h3 M4.9 4.9l2.2 2.2 M16.9 16.9l2.2 2.2 M4.9 19.1l2.2-2.2 M16.9 7.1l2.2-2.2", fill: false },
        "terminal": { d: "M3 5h18a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z M7 9l3 3-3 3 M13 15h4", fill: false },
        ...
        "download": { d: "M12 3v12 M7.5 10.5l4.5 4.5 4.5-4.5 M5 21h14", fill: false },
                "screen": { d: "M4 4h16a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-16a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2z M8 21h8 M12 17v4 M7 13c1.5-4 3-4 5-1s3.5 2 5-2", fill: false },
        "monitor": { d: "M4 8h16a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z M5.5 8V4 M9.8 8V4 M14.2 8V4 M18.5 8V4 M5.5 16v4 M9.8 16v4 M14.2 16v4 M18.5 16v4", fill: false },
        "smartphone": { d: "M7 3.5h10a1.5 1.5 0 0 1 1.5 1.5v14a1.5 1.5 0 0 1-1.5 1.5H7A1.5 1.5 0 0 1 5.5 19V5A1.5 1.5 0 0 1 7 3.5z M11 18h2", fill: false },
        "laptop": { d: "M5 5.5h14a1 1 0 0 1 1 1V16H4V6.5a1 1 0 0 1 1-1z M2 19h20 M9 16v2 M15 16v2", fill: false },
        "apple": { d: "M16.5 6.5c-.8.9-1.9 1.4-3 1.3-.1-1.1.4-2.3 1.1-3 .8-.9 2-1.5 3-1.5.1 1.1-.3 2.3-1.1 3.2z M17.8 20c-1 1.4-2 2.8-3.6 2.9-1.5 0-2-1-3.7-1s-2.2 1-3.7.9c-1.6 0-2.7-1.5-3.6-2.9-2-2.8-3.5-8-1.5-11.5 1-1.7 2.7-2.8 4.6-2.8 1.5 0 2.6 1 3.7 1s2.5-1.1 4.2-1c.7 0 2.7.3 4 2.2-.1.1-2.4 1.4-2.3 4.1 0 3.2 2.8 4.3 2.9 4.3-.1.3-.5 1.6-1.5 2.8z", fill: false },
        ...
        "wireless-combo": { d: "M4 9C8.5 5 15.5 5 20 9 M7 12c2.8-2.2 7.2-2.2 10 0 M10 15c1-0.8 3-0.8 4 0 M11.2 18a0.8 0.8 0 1 0 1.6 0a0.8 0.8 0 1 0-1.6 0", fill: false },
...
"record": { d: "M2 7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z M16 10.5l6-3.5v10l-6-3.5", fill: false },
"sendin": { d: "M22 2L11 13 M22 2l-7 20-4-9-9-4 20-7z", fill: false },
        ...
        "localsend": { d: "M12 7a5 5 0 1 0 0 10 5 5 0 1 0 0-10z M9 2a10.5 10.5 0 0 1 6 0a1.1 1.1 0 0 1-.6 2.1a8.3 8.3 0 0 0-4.8 0A1.1 1.1 0 0 1 9 2z M19.2 4.4a10.5 10.5 0 0 1 3 5.2a1.1 1.1 0 0 1-2.2.5a8.3 8.3 0 0 0-2.4-4.1a1.1 1.1 0 0 1 1.6-1.6z M22.2 14.4a10.5 10.5 0 0 1-3 5.2a1.1 1.1 0 0 1-1.6-1.6a8.3 8.3 0 0 0 2.4-4.1a1.1 1.1 0 0 1 2.2.5z M15 22a10.5 10.5 0 0 1-6 0a1.1 1.1 0 0 1 .6-2.1a8.3 8.3 0 0 0 4.8 0a1.1 1.1 0 0 1 .6 2.1z M4.8 19.6a10.5 10.5 0 0 1-3-5.2a1.1 1.1 0 0 1 2.2-.5a8.3 8.3 0 0 0 2.4 4.1a1.1 1.1 0 0 1-1.6 1.6z M1.8 9.6a10.5 10.5 0 0 1 3-5.2a1.1 1.1 0 0 1 1.6 1.6a8.3 8.3 0 0 0-2.4 4.1a1.1 1.1 0 0 1-2.2-.5z", fill: true }
    })
